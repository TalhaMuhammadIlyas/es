...
class BookSessionLocators {
    ...
    // }
    get clear_email_tabby() {
        return $('//android.widget.EditText[@text="talha.ilyas@mailinator.com"]');
    }
    get testemailtabby() {
        return $('//android.widget.EditText');
    }
    get clear_phone_tabby() {
        return $('//android.widget.EditText[@text="53-625-8690"]');
    }
    get tabbyloginphone() {
        return $('//android.view.View[@resource-id="tabby-checkout"]/android.view.View/android.view.View[4]/android.view.View[1]/android.view.View/android.view.View[2]/android.view.View[1]/android.widget.EditText');
    }
    get closekeyboard() {
